...
public class InvoiceService implements IInvoiceService {
	 ...
	 *
	 * @see
	 * rw.mutuelle.service.IInvoiceService#calculateInvoiceAmount(rw.mutuelle.model.
	 * MedicalAct)
	 */
	@Override
	...
	@Override
	public DetailedInvoice savePatientTreatementTransaction(final List<MedicalAct> treatementList,
			final Patient patient, final Users processedBy) {
		...
		populateDetailedInvoice(patient, healthFacility, detailedInvoice, servedServiceList, totalAmount,
				patientPercentage, rssbPercentage);
	...
	private static void populateDetailedInvoice(final Patient patient, final HealthFacility healthFacility,
			final DetailedInvoice detailedInvoice, final List<MedicalService> servedServiceList, final long totalAmount,
			final long patientPercentage, final long rssbPercentage) {
	...
	private void createPatientInvoice(final Patient patient, final Users processedBy,
			final HealthFacility healthFacility, final long totalAmount, final long patientPercentage,
